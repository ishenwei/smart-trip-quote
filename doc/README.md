...
│   │   ├── 0004_requirement_origin_input_and_more.py
│   │   ├── 0005_attraction_restaurant.py
│   │   ├── 0006_hotel.py
│   │   ├── 0007_itinerary.py
│   │   ├── 0008_travelerstats.py
│   │   ├── 0009_destination.py
│   │   ├── 0010_dailyschedule.py
│   │   ├── 0011_alter_attraction_options_alter_hotel_options_and_more.py
│   │   ├── 0012_alter_itinerary_itinerary_id.py
│   │   ├── 0013_remove_dailyschedule_daily_sched_city_na_2e042a_idx_and_more.py
│   │   ├── 0014_remove_requirement_id_itinerary_itinerary_json_data_and_more.py
│   │   ├── 0015_alter_attraction_table_comment_and_more.py
│   │   ├── 0016_alter_attraction_category_alter_attraction_status.py
│   │   ├── __init__.py
│   ├── models/            # 数据模型
│   │   ├── __init__.py
│   │   ├── attraction.py  # 景点模型
│   │   ├── base.py        # 基础模型
│   │   ├── daily_schedule.py # 日行程模型
│   │   ├── destinations.py # 目的地模型
...
│   │   ├── traveler_stats.py # 旅行者统计
│   │   ├── validators.py  # 验证器
│   ├── static/            # 静态文件
│   │   ├── admin/         # 管理后台静态文件
│   │   │   ├── js/        # JavaScript文件
│   │   │   │   ├── daily_schedule_filter.js # 日行程过滤器
│   ├── web/               # 前端应用
│   │   ├── public/        # 静态资源
│   │   │   ├── vite.svg
│   │   ├── src/           # 源代码
...
│   ├── TRAVEL_ITINERARY_WORKFLOW_DESIGN.md # 行程工作流设计
│   ├── TRAVEL_PLANNING_AI_WORKFLOW_SPEC.md # 旅行规划AI工作流规范
│   ├── travel_itinerary_planning_workflow.json # 行程规划工作流
├── services/              # 服务层
│   ├── llm/               # LLM服务
│   │   ├── providers/     # LLM提供商实现
│   │   │   ├── __init__.py
...
│   │   ├── apps/          # 应用模板
│   │   │   ├── requirement/ # 需求模板
│   │   │   │   ├── change_form.html # 变更表单
│   │   ├── dailyschedule_change_form_simple.html # 日行程变更表单
│   │   ├── dailyschedule_delete_confirmation_simple.html # 日行程删除确认
│   │   ├── day_schedule_inline.html # 日行程内联
│   │   ├── itinerary_change_form.html # 行程变更表单
│   │   ├── preview_itinerary.html # 行程预览
├── tests/                 # 测试目录
│   ├── reports/           # 测试报告
...
│   ├── __init__.py
│   ├── check_db_records.py # 检查数据库记录
│   ├── check_requirements.py # 检查需求
│   ├── fix_test.py        # 修复测试
│   ├── generate_test_data.py # 生成测试数据
│   ├── generate_test_data_for_iternary.py # 生成行程测试数据
...
│   ├── test_api.py        # API测试
│   ├── test_daily_schedule_filter.py # 日行程过滤器测试
│   ├── test_db_connection.py # 数据库连接测试
│   ├── test_display.py    # 显示测试
│   ├── test_iternary_data.json # 行程测试数据
│   ├── test_iternary_data2.json # 行程测试数据2
│   ├── test_iternary_parser.py # 行程解析器测试
│   ├── test_itinerary_data.json # 行程数据测试
