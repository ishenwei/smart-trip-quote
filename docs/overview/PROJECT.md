...
- **management/**: 管理命令，如生成测试数据等
- **migrations/**: 数据库迁移文件，记录数据模型变更
- **models/**: 数据模型定义，包含核心业务实体
- **static/**: 静态文件，如管理后台的JavaScript文件
- **web/**: 前端应用，基于Vue.js的现代化前端界面

#### 3.2.2 services/ 目录
- **llm/**: LLM服务实现，包含：
  - **providers/**: 不同LLM提供商的实现（OpenAI、Gemini、DeepSeek）
  - **base.py**: 基础抽象类
  - **cache.py**: 缓存管理
  - **config.py**: 配置管理
...
#### 3.2.5 n8n_workflows/ 目录
- 包含n8n工作流相关文件，用于旅行行程规划
...
| **位置异常处理** | 处理位置信息异常 | services/llm/location_exception_handler.py | LocationExceptionHandler | services/llm/location_exception_handler.py |
| **会话管理** | 管理LLM会话 | services/llm/conversation_manager.py | ConversationManager | services/llm/conversation_manager.py |
...
**功能描述**: 管理旅行行程，包括行程规划和安排

**核心组件**:

| 组件 | 功能 | 实现文件 | 关键类/方法 | 来源 |
|------|------|----------|-------------|------|
| **数据模型** | 定义行程数据结构 | apps/models/itinerary.py | Itinerary类 | apps/models/itinerary.py |
| **管理功能** | 行程管理后台 | apps/admin/itinerary.py | 行程相关管理功能 | apps/admin/itinerary.py |
| **日行程** | 每日行程安排 | apps/models/daily_schedule.py | DailySchedule类 | apps/models/daily_schedule.py |
...
| 组件 | 功能 | 实现文件 | 关键类/方法 | 来源 |
|------|------|----------|-------------|------|
| **数据模型** | 定义目的地数据结构 | apps/models/destinations.py | Destination类 | apps/models/destinations.py |
...
| 组件 | 功能 | 实现文件 | 关键类/方法 | 来源 |
|------|------|----------|-------------|------|
| **景点模型** | 定义景点数据结构 | apps/models/attraction.py | Attraction类 | apps/models/attraction.py |
| **餐厅模型** | 定义餐厅数据结构 | apps/models/restaurant.py | Restaurant类 | apps/models/restaurant.py |
...
| 组件 | 功能 | 实现文件 | 关键类/方法 | 来源 |
|------|------|----------|-------------|------|
| **酒店模型** | 定义酒店数据结构 | apps/models/hotel.py | Hotel类 | apps/models/hotel.py |
...
| 组件 | 功能 | 实现文件 | 关键类/方法 | 来源 |
|------|------|----------|-------------|------|
| **定价模型** | 定义定价数据结构 | apps/models/pricing.py | Pricing类 | apps/models/pricing.py |
| **定价规则** | 管理定价规则 | apps/admin/pricing_rule.py | 定价规则管理功能 | apps/admin/pricing_rule.py |
...
| **景点管理** | apps/admin/attraction.py | 景点管理 | apps/admin/attraction.py |
| **餐厅管理** | apps/admin/restaurant.py | 餐厅管理 | apps/admin/restaurant.py |
| **酒店管理** | apps/admin/hotel.py | 酒店管理 | apps/admin/hotel.py |
...
**Itinerary模型** (apps/models/itinerary.py)

| 字段名 | 类型 | 描述 | 约束 | 来源 |
|--------|------|------|------|------|
| **id** | AutoField | 主键 | 自动 | apps/models/itinerary.py |
| **itinerary_id** | CharField(50) | 行程ID | 唯一 | apps/models/itinerary.py |
| **requirement** | ForeignKey | 关联的需求 | 可选 | apps/models/itinerary.py |
| **name** | CharField(200) | 行程名称 | 必需 | apps/models/itinerary.py |
| **description** | TextField | 行程描述 | 可选 | apps/models/itinerary.py |
| **status** | CharField(20) | 行程状态 | 默认Draft | apps/models/itinerary.py |
| **created_at** | DateTimeField | 创建时间 | 自动 | 继承自BaseModel |
| **updated_at** | DateTimeField | 更新时间 | 自动 | 继承自BaseModel |

**DailySchedule模型** (apps/models/daily_schedule.py)

| 字段名 | 类型 | 描述 | 约束 | 来源 |
|--------|------|------|------|------|
| **id** | AutoField | 主键 | 自动 | apps/models/daily_schedule.py |
| **itinerary** | ForeignKey | 关联的行程 | 必需 | apps/models/daily_schedule.py |
| **day_number** | IntegerField | 第几天 | 必需 | apps/models/daily_schedule.py |
| **city_name** | CharField(100) | 城市名称 | 必需 | apps/models/daily_schedule.py |
| **activities** | JSONField | 活动安排 | 默认空列表 | apps/models/daily_schedule.py |
| **created_at** | DateTimeField | 创建时间 | 自动 | 继承自BaseModel |
| **updated_at** | DateTimeField | 更新时间 | 自动 | 继承自BaseModel |

**Attraction模型** (apps/models/attraction.py)

| 字段名 | 类型 | 描述 | 约束 | 来源 |
|--------|------|------|------|------|
| **id** | AutoField | 主键 | 自动 | apps/models/attraction.py |
| **name** | CharField(200) | 景点名称 | 必需 | apps/models/attraction.py |
| **city** | CharField(100) | 所在城市 | 必需 | apps/models/attraction.py |
| **country** | CharField(100) | 所在国家 | 必需 | apps/models/attraction.py |
| **category** | CharField(50) | 景点类别 | 可选 | apps/models/attraction.py |
| **description** | TextField | 景点描述 | 可选 | apps/models/attraction.py |
| **price** | DecimalField | 门票价格 | 可选 | apps/models/attraction.py |
| **opening_hours** | CharField(200) | 开放时间 | 可选 | apps/models/attraction.py |
| **duration** | IntegerField | 建议游览时间(分钟) | 可选 | apps/models/attraction.py |
| **status** | CharField(20) | 状态 | 默认Active | apps/models/attraction.py |
| **options** | JSONField | 附加选项 | 默认空字典 | apps/models/attraction.py |
| **created_at** | DateTimeField | 创建时间 | 自动 | 继承自BaseModel |
| **updated_at** | DateTimeField | 更新时间 | 自动 | 继承自BaseModel |

**Restaurant模型** (apps/models/restaurant.py)

| 字段名 | 类型 | 描述 | 约束 | 来源 |
|--------|------|------|------|------|
| **id** | AutoField | 主键 | 自动 | apps/models/restaurant.py |
| **name** | CharField(200) | 餐厅名称 | 必需 | apps/models/restaurant.py |
| **city** | CharField(100) | 所在城市 | 必需 | apps/models/restaurant.py |
| **country** | CharField(100) | 所在国家 | 必需 | apps/models/restaurant.py |
| **cuisine** | CharField(100) | 菜系 | 可选 | apps/models/restaurant.py |
| **price_range** | CharField(50) | 价格范围 | 可选 | apps/models/restaurant.py |
| **rating** | DecimalField | 评分 | 可选 | apps/models/restaurant.py |
| **description** | TextField | 餐厅描述 | 可选 | apps/models/restaurant.py |
| **options** | JSONField | 附加选项 | 默认空字典 | apps/models/restaurant.py |
| **created_at** | DateTimeField | 创建时间 | 自动 | 继承自BaseModel |
| **updated_at** | DateTimeField | 更新时间 | 自动 | 继承自BaseModel |

**Hotel模型** (apps/models/hotel.py)

| 字段名 | 类型 | 描述 | 约束 | 来源 |
|--------|------|------|------|------|
| **id** | AutoField | 主键 | 自动 | apps/models/hotel.py |
| **name** | CharField(200) | 酒店名称 | 必需 | apps/models/hotel.py |
| **city** | CharField(100) | 所在城市 | 必需 | apps/models/hotel.py |
| **country** | CharField(100) | 所在国家 | 必需 | apps/models/hotel.py |
| **stars** | IntegerField | 星级 | 1-5 | apps/models/hotel.py |
| **price_per_night** | DecimalField | 每晚价格 | 可选 | apps/models/hotel.py |
| **description** | TextField | 酒店描述 | 可选 | apps/models/hotel.py |
| **amenities** | JSONField | 设施 | 默认空列表 | apps/models/hotel.py |
| **options** | JSONField | 附加选项 | 默认空字典 | apps/models/hotel.py |
| **created_at** | DateTimeField | 创建时间 | 自动 | 继承自BaseModel |
| **updated_at** | DateTimeField | 更新时间 | 自动 | 继承自BaseModel |

**Destination模型** (apps/models/destinations.py)

| 字段名 | 类型 | 描述 | 约束 | 来源 |
|--------|------|------|------|------|
| **id** | AutoField | 主键 | 自动 | apps/models/destinations.py |
| **name** | CharField(200) | 目的地名称 | 必需 | apps/models/destinations.py |
| **type** | CharField(50) | 目的地类型 | 必需 | apps/models/destinations.py |
| **country** | CharField(100) | 所在国家 | 必需 | apps/models/destinations.py |
| **description** | TextField | 目的地描述 | 可选 | apps/models/destinations.py |
| **created_at** | DateTimeField | 创建时间 | 自动 | 继承自BaseModel |
| **updated_at** | DateTimeField | 更新时间 | 自动 | 继承自BaseModel |
...
| **用户手册** | doc/USER_MANUAL.md | 用户使用手册 | doc/USER_MANUAL.md |
