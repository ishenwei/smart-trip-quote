...
class Hotel(BaseModel):
    ...
    hotel_id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, verbose_name='酒店ID')
    ...
    brand_name = models.CharField(max_length=100, blank=True, verbose_name='品牌名称')
    ...
    room_facilities = JSONField(verbose_name='房间设施', default=dict)
    business_facilities = JSONField(verbose_name='商务设施', default=dict)
    room_types = JSONField(verbose_name='房型信息', default=dict)
    price_range = models.CharField(max_length=50, blank=True, verbose_name='价格范围')
    ...
    image_gallery = JSONField(verbose_name='图片库', default=list)
