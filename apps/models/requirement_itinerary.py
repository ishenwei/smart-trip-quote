...
class RequirementItinerary(BaseModel):
    ...
    itinerary = models.ForeignKey(Itinerary, on_delete=models.CASCADE, to_field='itinerary_id', related_name='requirement_itineraries', verbose_name='行程', db_comment='关联至itineraries表的主键')
